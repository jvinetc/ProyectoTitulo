...
@NamedQueries({
    ...
    @NamedQuery(name = "PproMenu.porPerfil", query = "SELECT p FROM PproMenu p INNER JOIN p.pproRelPerfilMenuCollection pr WHERE pr.rpmPerfId = :perfilId")})
@ManagedBean
@SessionScoped
public class PproMenu implements Serializable {
    ...
    public String toString() {
        return "ppro.modelo.PproMenu[ menId=" + menId + " ]";
    }
